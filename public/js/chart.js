...
module.exports.easing = __webpack_require__(182);
module.exports.canvas = __webpack_require__(183);
module.exports.options = __webpack_require__(184);
...
var helpers = __webpack_require__(1);
var basic = __webpack_require__(194);
...
window.Chart = __webpack_require__(180);
...
Vue.component('chart', {
    ...
    mounted: function mounted() {
        ...
        for (var i = this.dataSet[0].year; i < this.dataSet[this.dataSet.length - 1].year; i++) {
            var missing = this.dataSet.every(function (val) {
                return val.year != i;
            });
        ...
        var myChart = new Chart(document.getElementById("bar-chart-canvas").getContext('2d'), {
            type: 'bar',
            data: {
 ...
 * @namespace Chart
 */
var Chart = __webpack_require__(181)();
