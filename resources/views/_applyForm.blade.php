<form id="applyForm" method="POST" action="{{ $user? '/apply' : '/applyRegister' }}">
    ...
    <div class="alert alert-secondary d-flex justify-content-between align-items-center flex-column flex-lg-row flex-wrap">
        ...
        <div class="d-none d-lg-flex flex-column justify-content-center text-white m-0 font-weight-bold font-50px">&#8674;</div>
        <div class="d-flex d-lg-none flex-column justify-content-center text-white m-0 font-weight-bold font-50px">&#8675;</div>
        <div class="d-flex flex-column align-items-center mb-3">
